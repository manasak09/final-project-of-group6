...
fireEvent.change(screen.getByTestId('useremail'),{target:{value:'ragu@gmail.'}})
fireEvent.change(screen.getByTestId('password'),{target:{value:'ragu@1234'}})
fireEvent.click(screen.getByTestId('submitctrl'))
// expect(screen.getByTestId('msglbl').textContent).toBe("invalid details")
await waitFor(()=>expect(screen.getByTestId('msglbl').textContent).toBe('not an User!!!'))
